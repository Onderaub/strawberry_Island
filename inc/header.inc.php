...
<body style='height: 100vh;'>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand navbar-dark bg-primary navimage text-center" height=90>

            <div class="container-fluid">
                <a class="navbar-brand" href="<?= BASE_PATH; ?>"><img class="logo" src="assets\upload\logo.png" alt="Logo de Star'Island">
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-vector">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="<?= BASE_PATH . 'login.php'; ?>">Connexion</a>
                                <a class="dropdown-item" href="<?= BASE_PATH . 'register.php'; ?>">Inscription</a>
                    ...
                    <?php if (connect()) :           ?>
                        <a href="<?= BASE_PATH . '?a=dis'; ?>" class="btn btn-primary"></a>
                    <?php else :           ?>
                        <div class="d-flex flex-column">
                            <a href="encyclopedie.fr" class="btnTuto btn-success ms-3" width=16 height=16><img src="assets\images\Bouton_tuto.png"></a>
                            <a href="encyclopedie.fr" class="btnTuto btn-success" width=16 height=16><img src="assets\images\Bouton_avis.png"></a>
                        </div>
                    <?php endif;        ?>
