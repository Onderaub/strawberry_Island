...
<!-- <div class="table-responsive-xl">
  <table class="table">
    <thead>
      <tr>
        <th scope="col">#</th>
        <th scope="col">Rang 1 (gratuit)</th>
        <th scope="col">Rang 2</th>
        <th scope="col">Rang 3</th>
        <th scope="col">Rang 4</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <th scope="row">Politique</th>
        <td>Citoyen engagé</td>
        <td>Grand électeur</td>
        <td>Figure locale</td>
        <td>Ambassadeur</td>
      ...
      <tr>
        ...
        <td>Spécialiste</td>
        <td>Directeur</td>
        <td>Siège a la chambre du commerce et de l'industrie
      </tr>
      <tr>
        <th scope="row">Syndicat du Crime</th>
        <td>Vagabond</td>
        <td>Opportuniste</td>
        <td>Sort de prison</td>
        <td>Personne influante</td>
      </tr>
    </tbody>
  </table>
</div> -->
